...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('Salon.xml', function(err, result) {
      ...
      result.cafemenu.section[obj.sec_n].entree.push({'Client': obj.Client, 'Time': obj.Time}); //If your XML elements are differet, this is where you have to change to your own element names
